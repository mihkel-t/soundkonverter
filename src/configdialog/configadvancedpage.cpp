    ...
    , config(_config)
{
    ...
    lPreferredVorbisCommentCommentTag->setToolTip(
        i18n("Some applications use the field DESCRIPTION even though the field COMMENT is the correct one.\nComments will be written to the selected field, "
             "when reading tags the selected field will be preferred."));
    ...
    cPreferredVorbisCommentCommentTag->setToolTip(
        i18n("Some applications use the field DESCRIPTION even though the field COMMENT is the correct one.\nComments will be written to the selected field, "
             "when reading tags the selected field will be preferred."));
    ...
    lPreferredVorbisCommentTrackTotalTag->setToolTip(
        i18n("Total tracks number will be written to the selected field, when reading tags the selected field will be preferred.\nWhen using the field "
             "TRACKNUMBER, the track number and the total tracks number will be written to the same field separated by a slash ('/')."));
    ...
    cPreferredVorbisCommentTrackTotalTag->setToolTip(
        i18n("Total tracks number will be written to the selected field, when reading tags the selected field will be preferred.\nWhen using the field "
             "TRACKNUMBER, the track number and the total tracks number will be written to the same field separated by a slash ('/')."));
    ...
    lPreferredVorbisCommentDiscTotalTag->setToolTip(
        i18n("Total discs number will be written to the selected field, when reading tags the selected field will be preferred.\nWhen using the field "
             "DISCNUMBER, the disc number and the total discs number will be written to the same field separated by a slash ('/')."));
    ...
    cPreferredVorbisCommentDiscTotalTag->setToolTip(
        i18n("Total discs number will be written to the selected field, when reading tags the selected field will be preferred.\nWhen using the field "
             "DISCNUMBER, the disc number and the total discs number will be written to the same field separated by a slash ('/')."));
    ...
    cUseVFATNames->setToolTip(
        i18n("Replaces some special characters like \'?\' by \'_\'.\nIf the output directory is on a FAT file system FAT compatible file names will "
    ...
    cUsePipes->setToolTip(
        i18n("Pipes make it unnecessary to use temporary files, therefore increasing the performance.\nBut some backends cause errors in this mode so be "
             "cautious."));
...
void ConfigAdvancedPage::somethingChanged()
{
    const bool changed = cPreferredOggVorbisExtension->currentText() != config->data.general.preferredOggVorbisExtension
        ...
        || cUseVFATNames->isChecked() != config->data.general.useVFATNames || cEjectCdAfterRip->isChecked() != config->data.advanced.ejectCdAfterRip
