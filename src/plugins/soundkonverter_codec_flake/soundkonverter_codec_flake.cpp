...
int soundkonverter_codec_flake::convert(const QUrl &inputFile,
                                        ...
                                        bool replayGain)
{
    ...
    connect(newItem->process, &QProcess::readyRead, this, &soundkonverter_codec_flake::processOutput);
    connect(newItem->process, &QProcess::finished, this, &soundkonverter_codec_flake::processExit);
...
QStringList soundkonverter_codec_flake::convertCommand(const QUrl &inputFile,
                                                       const QUrl &outputFile,
                                                       const QString &inputCodec,
                                                       const QString &outputCodec,
                                                       const ConversionOptions *_conversionOptions,
