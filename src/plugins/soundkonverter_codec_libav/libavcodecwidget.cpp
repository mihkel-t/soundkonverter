    ...
    , currentFormat("ogg vorbis")
{
    ...
    connect(sBitrate, &QAbstractSlider::valueChanged, this, &LibavCodecWidget::qualitySliderChanged);
    connect(sBitrate, &QAbstractSlider::valueChanged, this, &CodecWidget::optionsChanged);
    ...
    connect(iBitrate, &QSpinBox::valueChanged, this, &LibavCodecWidget::qualitySpinBoxChanged);
    connect(iBitrate, &QSpinBox::valueChanged, this, &CodecWidget::optionsChanged);
...
ConversionOptions *LibavCodecWidget::currentConversionOptions()
{
...
void LibavCodecWidget::setCurrentFormat(const QString &format)
{
...
QString LibavCodecWidget::currentProfile()
{
...
int LibavCodecWidget::currentDataRate()
{
    int dataRate;
...
void LibavCodecWidget::qualitySliderChanged(int bitrate)
{
    iBitrate->setValue(bitrate);
}

void LibavCodecWidget::qualitySpinBoxChanged(int bitrate)
{
