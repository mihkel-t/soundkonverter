                                        ...
                                        bool replayGain)
{
    ...
    connect(newItem->process, &QIODevice::readyRead, this, &soundkonverter_codec_aften::processOutput);
    connect(newItem->process, &QProcess::finished, this, &soundkonverter_codec_aften::processExit);
