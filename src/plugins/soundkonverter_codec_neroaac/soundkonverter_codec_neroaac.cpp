...
QList<ConversionPipeTrunk> soundkonverter_codec_neroaac::codecTable()
{
    ...
    newTrunk.problemInfo = standardMessage("encode_codec,backend", "m4a/aac", "neroAacEnc") + "\n"
        + i18n("You can download '%1' at '%2' after entering an email address.",
               QString("neroAacEnc"),
               QString("http://www.nero.com/enu/downloads-nerodigital-nero-aac-codec.php"));
...
int soundkonverter_codec_neroaac::convert(const QUrl &inputFile,
...
QStringList soundkonverter_codec_neroaac::convertCommand(const QUrl &inputFile,
                                                         const QUrl &outputFile,
                                                         const QString &inputCodec,
                                                         const QString &outputCodec,
                                                         const ConversionOptions *_conversionOptions,
