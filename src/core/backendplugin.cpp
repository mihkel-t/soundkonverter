...
BackendPlugin::FormatInfo BackendPlugin::formatInfo(const QString &codecName)
{
    ...
    if (codecName == u"wav"_s) {
        ...
        info.description = i18n(
            "Wave is a very simple audio format that doesn't compress the audio stream so it's lossless but the file size is very big and it doesn't support "
            "advanced features like tags.<br>It is supported by virtually any software or device.<br><br><a "
        ...
        info.description = i18n(
            "Advanced Audio Coding (AAC) is a lossy and popular audio format. It is widely used by Apple Inc.<br>In soundKonverter \"aac\" refers to only the "
            "codec. In order to get a file with tagging capabilities use \"m4a/aac\".<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/Advanced_Audio_Coding\">http://en.wikipedia.org/wiki/Advanced Audio Coding</a>");
        info.mimeTypes.append("audio/aac");
        info.extensions.append("aac");
    } else if (codecName == "m4a/aac") {
        info.priority = 90;
        info.description = i18n(
            "Advanced Audio Coding (AAC) is a lossy and popular audio format. It is widely used by Apple Inc.<br>In soundKonverter \"m4a/aac\" refers to a "
            "MPEG-4 audio file encoded with AAC.<br><br><a href=\"http://en.wikipedia.org/wiki/Advanced_Audio_Coding\">http://en.wikipedia.org/wiki/Advanced "
            "Audio Coding</a>");
        ...
        info.lossless = true;
        info.description = i18n(
            "Apple Lossless Audio Codec (ALAC) is a lossless audio format. It is widely used by Apple Inc.<br>In soundKonverter \"m4a/alac\" refers to a "
            "MPEG-4 audio file encoded with ALAC.<br><br><a href=\"http://en.wikipedia.org/wiki/Apple_Lossless\">http://en.wikipedia.org/wiki/Apple "
            "Lossless</a>");
        info.mimeTypes.append("audio/mp4");
        info.mimeTypes.append("audio/x-m4a");
        info.extensions.append("m4a");
        ...
        info.description = i18n(
            "Ogg Vorbis is a lossy and popular audio format.<br>It is free of any legal restrictions.<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/Vorbis\">http://en.wikipedia.org/wiki/Vorbis</a>");
        ...
        info.description = i18n(
            "Opus is a lossy audio format designed for real time communication over the internet.<br>It can cover a wide range of bitrates with a high quality "
            "and it is free of any legal restrictions.<br><br><a href=\"http://en.wikipedia.org/wiki/Opus_(audio_format)\">http://en.wikipedia.org/wiki/Opus "
            "(audio format)</a>");
        info.mimeTypes.append("audio/ogg");
        ...
        info.description = i18n(
            "MPEG-1 or MPEG-2 Audio Layer III (MP3) is the most popular lossy audio format.<br>It is supported by virtually all audio players even though it "
            "has some legal restrictions.<br><br><a href=\"http://en.wikipedia.org/wiki/MP3\">http://en.wikipedia.org/wiki/MP3</a>");
        ...
        info.lossless = true;
        info.description = i18n(
            "Free Lossless Audio Codec (FLAC) is a lossless audio format.<br>It is free of any legal restrictions.<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/FLAC\">http://en.wikipedia.org/wiki/FLAC</a>");
        ...
        info.description = i18n(
            "Windows Media Audio (WMA) is a lossy audio format developed by Microsoft.<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/Windows_Media_Audio\">http://en.wikipedia.org/wiki/Windows Media Audio</a>");
        info.mimeTypes.append("audio/x-ms-wma");
        info.extensions.append("wma");
    } else if (codecName == "ac3") {
        info.description = i18n(
            "AC3 or AC-3 is part of the Dolby Digital format family.<br>It was designed to be used for movies (e.g. DVDs) and supports surround "
            "sound.<br><br><a href=\"http://en.wikipedia.org/wiki/Dolby_Digital\">http://en.wikipedia.org/wiki/Dolby Digital</a>");
    ...
    //     }
        ...
        info.description = i18n(
            "MPEG-1 or MPEG-2 Audio Layer II (MP2) is an old lossy audio format.<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/MPEG-1_Audio_Layer_II\">http://en.wikipedia.org/wiki/MPEG-1 Audio Layer II</a>");
    ...
    else if (codecName == "als") // TODO mime type, etc.
    {
        ...
        info.description = i18n(
            "Adaptive Multi-Rate Narrow-Band (AMR NB) is mainly used for speech compression for mobile communication.<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/Adaptive_Multi-Rate_audio_codec\">http://en.wikipedia.org/wiki/Adaptive Multi-Rate audio codec</a>");
        ...
        info.inferiorQuality = true;
        info.description = i18n(
            "Adaptive Multi-Rate Wide-Band (AMR WB) is an advanced version of AMR NB which uses a higher data rate resulting in a higher quality.<br>Still it "
            "should be used only for speech compression.<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/Adaptive_Multi-Rate_Wideband\">http://en.wikipedia.org/wiki/Adaptive Multi-Rate Wideband</a>");
        ...
        info.lossless = true;
        info.description = i18n(
            "Monkey's Audio is a lossless audio format.<br><br><a href=\"http://en.wikipedia.org/wiki/Monkey's_Audio\">http://en.wikipedia.org/wiki/Monkey's "
            "Audio</a>");
        ...
        info.inferiorQuality = true;
        info.description = i18n(
            "Speex is a lossy audio format designed for speech encoding.<br>It is free of any legal restrictions. Since the release of Opus, Speex is "
            "considered obsolete.<br><br><a href=\"http://en.wikipedia.org/wiki/Speex\">http://en.wikipedia.org/wiki/Speex<a/>");
        ...
        info.description = i18n(
            "Musepack (MPC) is a free and lossy file format based on mp2 and optimized for high quality.<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/Musepack\">http://en.wikipedia.org/wiki/Musepack<a/>");
        ...
        info.lossless = true;
        info.description = i18n(
            "Shorten (SHN) is a free and lossless audio format.<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/Shorten\">http://en.wikipedia.org/wiki/Shorten</a>");
    ...
    //     }
        ...
        info.description = i18n(
            ...
            "href=\"http://en.wikipedia.org/wiki/TTA_(codec)\">http://en.wikipedia.org/wiki/TTA (codec)<a/>");
        info.mimeTypes.append("audio/x-tta");
        info.extensions.append("tta");
    } else if (codecName == "wavpack") {
        info.lossless = true;
        info.description = i18n(
            "WavPack (WV) is a free and lossless audio format.<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/WavPack\">http://en.wikipedia.org/wiki/WavPack<a/>");
        ...
        info.inferiorQuality = true;
        info.description = i18n(
            "8-Bit Sampled Voice (8SVX) is an audio file format standard developed by Electronic Arts for the Commodore-Amiga computer series.<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/8SVX\">http://en.wikipedia.org/wiki/8SVX</a>");
        ...
        info.lossless = true;
        info.description = i18n(
            "Audio Interchange File Format (AIFF) is a very simple audio format that doesn't compress the audio stream so it's lossless but the file size is "
            "very big and it doesn't support advanced features like tags.<br><br><a "
            "href=\"http://en.wikipedia.org/wiki/Audio_Interchange_File_Format\">http://en.wikipedia.org/wiki/Audio Interchange File Format</a>");
        info.mimeTypes.append("audio/x-aiff");
        info.mimeTypes.append("audio/aiff");
...
QString BackendPlugin::standardMessage(const QString &type, const QStringList &arguments) const
{
    ...
    if (type == "install_patented_backend") {
        ...
        return i18n(
            "Since '%1' includes patented codecs, it may not be included in the default installation of your distribution. Many distributions offer '%1' in an "
