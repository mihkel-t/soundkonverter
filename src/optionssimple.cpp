...
void OptionsSimple::profileInfo()
{
    ...
    if (sProfileString == i18n("Very low")) {
        info = i18n(
            "Encoding files with a very low quality can be useful if you have a mobile device where your storage space is limited.\nIt is not recommended to "
            "save your music in this quality without a copy of higher quality.");
    } else if (sProfileString == i18n("Low")) {
        info = i18n(
            "Encoding files with a low quality can be useful if you have a mobile device where your storage space is limited.\nIt is not recommended to save "
            "your music in this quality without a copy of higher quality.");
    } else if (sProfileString == i18n("Medium")) {
        info = i18n(
            "Encoding files with a medium quality is a compromise between quality and file size.\nMost people might not hear much of a difference to the "
            "original files but you should only use it to save music if your storage space is limited.");
...
//             additional Replay Gain plugin.",cFormat->currentText());
//         }
