...
class FileList : public QTreeWidget
{
    Q_OBJECT
public:
    enum Columns { Column_State = 0, Column_Input = 1, Column_Output = 2, Column_Quality = 3 };
    ...
    FileListItem *topLevelItem(int index) const
    {
        return static_cast<FileListItem *>(QTreeWidget::topLevelItem(index));
    }

    void setOptionsLayer(OptionsLayer *_optionsLayer)
    {
